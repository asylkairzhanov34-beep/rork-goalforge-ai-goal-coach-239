...
export const REWARDS: Reward[] = [
  ...
  { 
    ...
    category: 'streak', 
    requirement: 3, 
    requirementLabel: '3 days',
    unlockHint: 'Maintain 3 day streak'
  },
  { 
    id: 's3', 
    ...
    category: 'streak', 
    requirement: 7, 
    requirementLabel: '7 days',
    unlockHint: 'Complete 1 week streak'
  },
  { 
    id: 's4', 
    ...
    category: 'streak', 
    requirement: 14, 
    requirementLabel: '14 days',
    unlockHint: 'Maintain 2 week streak'
  },
  { 
    id: 's5', 
    ...
    category: 'streak', 
    requirement: 30, 
    requirementLabel: '30 days',
    unlockHint: 'Complete 1 month streak'
  },
  { 
    id: 's6', 
    ...
    category: 'streak', 
    requirement: 60, 
    requirementLabel: '60 days',
    unlockHint: 'Maintain 2 month streak'
  },
  { 
    id: 's7', 
    ...
    category: 'streak', 
    requirement: 90, 
    requirementLabel: '90 days',
    unlockHint: 'Complete 3 month streak'
  },
  { 
    id: 's8', 
    ...
    category: 'streak', 
    requirement: 180, 
    requirementLabel: '180 days',
    unlockHint: 'Maintain 6 month streak'
  },

  // TASKS REWARDS (5 unique orbs)
  { 
    id: 't1', 
    video: 'https://res.cloudinary.com/dohdrsflw/video/upload/v1769963787/0126_13_hoa56y.mp4', 
    label: 'Doer', 
    unlocked: false, 
    color: '#F59E0B', 
    ...
    category: 'tasks', 
    requirement: 5, 
    requirementLabel: '5 tasks',
    unlockHint: 'Complete 5 tasks'
  },
  { 
    id: 't2', 
    ...
    unlocked: false, 
    color: '#8B5CF6', 
    achievement: '25 tasks completed', 
    rarity: 'Rare', 
    ownedBy: '40%', 
    category: 'tasks', 
    requirement: 25, 
    requirementLabel: '25 tasks',
    unlockHint: 'Complete 25 tasks'
  },
  { 
    id: 't3', 
    video: 'https://res.cloudinary.com/dohdrsflw/video/upload/v1769970927/0126_20_bdhdiu.mp4', 
    label: 'Unstoppable', 
    unlocked: false, 
    color: '#10B981', 
    achievement: '50 tasks completed', 
    rarity: 'Epic', 
    ownedBy: '20%', 
    category: 'tasks', 
    requirement: 50, 
    requirementLabel: '50 tasks',
    unlockHint: 'Complete 50 tasks'
  },
  { 
    id: 't4', 
    ...
    unlocked: false, 
    color: '#06B6D4', 
    achievement: '100 tasks completed', 
    rarity: 'Legendary', 
    ownedBy: '8%', 
    category: 'tasks', 
    requirement: 100, 
    requirementLabel: '100 tasks',
  ...
  { 
    ...
    unlocked: false, 
    color: '#D946EF', 
    achievement: '250 tasks completed', 
    rarity: 'Mythic', 
    ownedBy: '2%', 
    category: 'tasks', 
    requirement: 250, 
    requirementLabel: '250 tasks',
    unlockHint: 'Complete 250 tasks'
  },

  // FOCUS TIME REWARDS (2 unique orbs)
  { 
    id: 'f1', 
    ...
    unlocked: false, 
    color: '#FB923C', 
    achievement: '1 hour focused', 
    rarity: 'Common', 
    ownedBy: '80%', 
    category: 'focus', 
    requirement: 60, 
    requirementLabel: '1 hour',
    unlockHint: 'Focus for 1 hour total'
  },
  { 
    id: 'f2', 
    video: 'https://res.cloudinary.com/dohdrsflw/video/upload/v1769956418/0126_8_xka62k.mp4', 
    label: 'Deep Mind', 
    unlocked: false, 
    color: '#38BDF8', 
    achievement: '5 hours focused', 
    rarity: 'Rare', 
    ownedBy: '35%', 
    category: 'focus', 
    requirement: 300, 
    requirementLabel: '5 hours',
    unlockHint: 'Focus for 5 hours total'
  },
];
