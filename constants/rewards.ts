...
export const REWARDS: Reward[] = [
  ...
  { id: '3', video: GRAY_ORB_VIDEO, label: 'Week Goal', unlocked: false, color: '#A78BFA', achievement: 'Complete 7 days', rarity: 'Rare', ownedBy: '45%' },
  { id: '4', video: GRAY_ORB_VIDEO, label: '7 Day Streak', unlocked: false, color: '#34D399', achievement: '7 day streak', rarity: 'Rare', ownedBy: '32%' },
